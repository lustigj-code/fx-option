...
const REMEMBER_DEVICE_KEY = 'fx-admin:remember-device';
...
export function SignInForm({
  ...
  const handleSubmit = async ({ email, password, rememberDevice }: LoginFormValues) => {
    ...
    try {
      ...
      console.error('Admin sign-in failed', submitError);
  ...
  return (
    <LoginForm
      ...
      subtitle="Privileged access restricted to compliance and operations leads."
    />
  );
}
