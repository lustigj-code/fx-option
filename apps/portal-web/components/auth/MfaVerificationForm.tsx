...
const DEFAULT_ERROR = 'Unable to verify the code. Please try again.';
...
export function MfaVerificationForm({
  ...
  const handleSubmit = async (code: string) => {
    ...
    try {
      ...
      console.error('Portal MFA verification failed', submitError);
  ...
  return (
    <MfaPrompt
      ...
      onUseRecoveryCode={() =>
        setError('Recovery codes are not yet available. Contact support if you are locked out.')
      }
    />
  );
}
